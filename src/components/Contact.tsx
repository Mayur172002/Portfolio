        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          <div ref={formRef} className="space-y-6">
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button
                type="submit"
                className="group w-full inline-flex items-center justify-center gap-3 px-8 py-4 bg-gradient-primary text-primary-foreground rounded-lg font-medium hover:shadow-glow-primary transition-all duration-300 hover:scale-105"
              >
                Send Message
                <PaperPlaneTilt
                  size={20}
          ...
          <div ref={infoRef} className="space-y-8">
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-4 p-4 glass rounded-lg hover:shadow-glow-primary transition-all duration-300">
                ...
                <a href="mailto:mayurbhaliya32@gmail.com" className="cursor-pointer no-underline">
                  <div>
                    <p className="text-foreground font-medium">Email</p>
                    <p className="text-muted-foreground">mayurbhaliya32@gmail.com</p>
                  </div>
                </a>
              </div>
              ...
              <div className="flex items-center gap-4 p-4 glass rounded-lg hover:shadow-glow-secondary transition-all duration-300">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">+91 93161 98593</p>
                </div>
              </div>
