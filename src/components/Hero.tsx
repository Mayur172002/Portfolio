...
const Hero = () => {
  ...
  const downloadCV = () => {
    ...
    link.href = '/Mayur Bhaliya.pdf'; // File path relative to public folder
    link.download = 'Mayur Bhaliya.pdf';
  ...
  return (
    ...
    >
      ...
      <div
        ref={orbRef1}
        className="absolute top-1/4 left-1/4 w-32 h-32 bg-primary/20 rounded-full blur-xl animate-pulse"
      />
      <div
        ref={orbRef2}
      ...
      <div className="relative z-10 text-center px-6 max-w-4xl mx-auto">
        ...
        >
          Crafting digital experiences that inspire, engage, and elevate through innovative design and cutting-edge technology.
        </p>
